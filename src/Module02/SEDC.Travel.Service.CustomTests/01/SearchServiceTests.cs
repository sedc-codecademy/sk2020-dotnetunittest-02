...
namespace SEDC.Travel.Service.CustomTests._01
{
    public class SearchServiceTests
    {
        ...
        public void GetHotels_TwoExistingHotels_ShouldReturnExceptionBecouseOfTheGetCountryNameMethod()
        {
            ...
            var mockedHotels = new List<Hotel>
            {
                new Hotel { Id=1, Code="01", Name="Hotel Royal Skopje", Description="Des", City="Skopje", Address="bb", CountryId=1, HotelCategoryId=1, Web="http://rojal.mk" },
                new Hotel { Id=2, Code="02", Name="Hotel Royal", Description="Des", City="Skopje", Address="bb", CountryId=1, HotelCategoryId=1, Web="http://rojal.mk" },
            };
            var mockedHotelCategory = new HotelCategory { Id = 1, Code = "03", Description = "3 Stars" };
            var categoryId = 1;
